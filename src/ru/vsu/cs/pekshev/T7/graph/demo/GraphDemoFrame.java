...
import ru.vsu.cs.pekshev.T7.graph.Graph;
import ru.vsu.cs.pekshev.T7.graph.GraphAlgorithms;
import ru.vsu.cs.pekshev.T7.graph.GraphUtils;
    ...
    public GraphDemoFrame() {
        ...
        buttonCreateGraph.addActionListener(e -> {
            try {
                ...
                Class clz = Class.forName("ru.vsu.cs.pekshev.T7.graph." + className);
                ...
                int vertex = Task.getVertex((WeightedGraph) graph, Double.parseDouble(textField2.getText()));
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        textAreaGraphFile.setText("6 1 0 10 0 2 3 1 3 6 0 4 10 2 3 4 3 4 5");
        ...
        textField1.setText("Номер города будет здесь");
        panel2.add(textField1, new GridConstraints(1, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        textField2 = new JTextField();
        panel2.add(textField2, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        final JLabel label1 = new JLabel();
        label1.setText("Введите N(double):");
        ...
        panel2.add(buttonSaveGraphToFile, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label2 = new JLabel();
        label2.setText("Ответ -1 означает отсутствие такого города");
        ...
        buttonCreateGraph.setText("Получить номер города");
        ...
        label4.setText("12. По системе двусторонних дорог определить, есть ли в ней город (вывести его), из которого можно добраться в любой другой менее чем за N км. \n");
        panel1.add(label4, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
